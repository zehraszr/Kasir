<nav class="sb-topnav navbar navbar-expand navbar-dark bg-info shadow-sm">
    <button class="btn btn-link btn-sm" id="sidebarToggle" href="#">
        <i class="fas fa-bars fa-fw font-weight-bold text-white"></i>
    </button>
    <a class="navbar-brand order-lg-first text-sm-center font-weight-bold" href="<?= base_url(); ?>">Book Store</a>
    <!-- Navbar-->
